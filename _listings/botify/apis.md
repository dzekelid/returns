...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/botify/apis.md
...
- name: Botify - Get Analyses Username Project Slug Analysis Slug Crawl Statistics
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/botify/analysesusernameproject-sluganalysis-slugcrawl-statisticstime-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/botify/analysesusernameproject-sluganalysis-slugcrawl-statisticstime-get-openapi.md
- name: Botify - Get Analyses Username Project Slug Analysis Slug Crawl Statistics
    Time
  x-api-slug: analysesusernameproject-sluganalysis-slugcrawl-statisticstime-get
  description: Return crawl statistics grouped by time frequency (1 min, 5 mins or
...
- name: Botify - Get Analyses Username Project Slug Analysis Slug Crawl Statistics
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/botify/analysesusernameproject-sluganalysis-slugcrawl-statisticsurlslist-type-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/botify/analysesusernameproject-sluganalysis-slugcrawl-statisticsurlslist-type-get-openapi.md
- name: Botify - Get Analyses Username Project Slug Analysis Slug Crawl Statistics
    Urls List Type
  x-api-slug: analysesusernameproject-sluganalysis-slugcrawl-statisticsurlslist-type-get
  description: Return a list of 1000 latest URLs crawled (all crawled URLs or only
...
- name: Botify - Post Analyses Username Project Slug Analysis Slug Urls Export
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/botify/analysesusernameproject-sluganalysis-slugurlsexport-post-openapi.md
- name: Botify - Post Analyses Username Project Slug Analysis Slug Urls Export
  x-api-slug: analysesusernameproject-sluganalysis-slugurlsexport-post
  description: Creates a new UrlExport object and starts a task that will export the
    results into a csv. Returns the model id that manages the task
...
- name: Botify - Get Analyses Username Project Slug Analysis Slug Urls Export Url
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/botify/analysesusernameproject-sluganalysis-slugurlsexporturl-export-id-get-openapi.md
- name: Botify - Get Analyses Username Project Slug Analysis Slug Urls Export Url
    Export
  x-api-slug: analysesusernameproject-sluganalysis-slugurlsexporturl-export-id-get
  description: Checks the status of an CSVUrlExportJob object. Returns json object
...
- name: Botify - Post Analyses Username Project Slug Analysis Slug Urls Suggested
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/botify/analysesusernameproject-sluganalysis-slugurlssuggested-filters-post-openapi.md
- name: Botify - Post Analyses Username Project Slug Analysis Slug Urls Suggested
    Filters
  x-api-slug: analysesusernameproject-sluganalysis-slugurlssuggested-filters-post
  description: Return most frequent segments (= suggested patterns in the previous
