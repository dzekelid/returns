...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-simple-queue-service/apis.md
...
- name: AWS Simple Queue Service API - Get Queue Url
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-simple-queue-service/actiongetqueueurl-get-openapi.md
- name: AWS Simple Queue Service API - List Dead Letter Source Queues
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-simple-queue-service/actionlistdeadlettersourcequeues-get-openapi.md
- name: AWS Simple Queue Service API - List Queues
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-simple-queue-service/actionlistqueues-get-openapi.md
x-common:
- type: x-api-gallery
