...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/apica/apis.md
...
- name: Checks API - Get Check List
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/apica/apiversionchecks-get-openapi.md
- name: Checks API - Get Check List
  x-api-slug: apiversionchecks-get
  description: Returns a list overview of all checks.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/19004-apica.jpg
