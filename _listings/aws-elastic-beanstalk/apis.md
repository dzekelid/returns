...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/apis.md
...
- name: AWS Elastic Beanstalk API - Describe Applications
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/actiondescribeapplications-get-openapi.md
- name: AWS Elastic Beanstalk API - Describe Configuration Settings
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/actiondescribeconfigurationsettings-get-openapi.md
- name: AWS Elastic Beanstalk API - Describe Environment Health
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/actiondescribeenvironmenthealth-get-openapi.md
- name: AWS Elastic Beanstalk API - Describe Environment Resources
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/actiondescribeenvironmentresources-get-openapi.md
- name: AWS Elastic Beanstalk API - Describe Environments
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/actiondescribeenvironments-get-openapi.md
- name: AWS Elastic Beanstalk API - Describe Events
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/actiondescribeevents-get-openapi.md
- name: AWS Elastic Beanstalk API - List Available Solution Stacks
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/actionlistavailablesolutionstacks-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/returns/master/_listings/aws-elastic-beanstalk/actionlistavailablesolutionstacks-get-openapi.md
x-common:
- type: x-api-gallery
